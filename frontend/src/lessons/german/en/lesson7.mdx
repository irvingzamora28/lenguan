...
<TextToSpeechPlayer mp3File={../assets/courses/german/_shared/lessons/lesson7/audio/food-vocabulary.mp3} />
...
<TextToSpeechPlayer mp3File={../assets/courses/german/_shared/lessons/lesson7/audio/drink-vocabulary.mp3} />
...
<!-- prettier-ignore -->
<TipBox>
- **Describing Food**: Use adjectives to describe food, such as "lecker" (delicious) or "süß" (sweet).
- **Ordering in a Restaurant**: Learn common phrases for ordering food, like "Ich hätte gerne..." (I would like...) or "Kann ich
