...
Mnemonic: Think of the sound you make when you're trying to fog up a mirror with your breath but make it harsher.
...
Mnemonic: Imagine the 'H' is like a silent ghost, floating through the word without making a sound.

<TextToSpeechPlayer mp3File={/src/assets/courses/spanish/_shared/lessons/lesson2/audio/silent-h.mp3} />
...
Mnemonic: Think of gargling softly in your throat.

<TextToSpeechPlayer mp3File={/src/assets/courses/spanish/_shared/lessons/lesson2/audio/g-before-e-i.mp3} />
...
Mnemonic: Imagine you're gently hissing like a snake.

<TextToSpeechPlayer mp3File={/src/assets/courses/spanish/_shared/lessons/lesson2/audio/c-before-e-i.mp3} />
...
Mnemonic: Think of the 'Ñ' as the 'n' in "onion" where it blends with a 'y' sound.

<TextToSpeechPlayer mp3File={/src/assets/courses/spanish/_shared/lessons/lesson2/audio/unique-n.mp3} />
