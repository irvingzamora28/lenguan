...
<Mnemonic
	title="Remember"
	content="Words ending in -o are often masculine, and those ending in -a are often feminine. But there are exceptions!"
/>
...
<!-- prettier-ignore -->
<TipBox>
- **Remember**: - Use articles and pronouns as clues to identify the gender of a noun.
</TipBox>
...
<!-- prettier-ignore -->
<TipBox>
- **Remember**: - Masculine nouns are often ending in -o, -or, or -ma.
</TipBox>
...
<!-- prettier-ignore -->
<TipBox>
- When encountering a new noun, try to determine if it follows the common patterns for feminine nouns based on its ending.
</TipBox>
...
<!-- prettier-ignore -->
<TipBox>
- **Remember**: - Adjectives must agree in gender with the nouns they describe.
</TipBox>
...
<!-- prettier-ignore -->
<TipBox>
- **Remember**: - Irregular nouns do not follow the general gender rules and need to be memorized individually. 
- Regular practice and exposure to these irregular nouns will aid in their retention.
</TipBox>
...
<!-- prettier-ignore -->
<TipBox>
- **Remember**: - Practice using masculine and feminine nouns in sentences to reinforce understanding.
</TipBox>
