...
<!-- prettier-ignore -->
<TipBox>
- **Remember**: - Keep in mind the use of present subjunctive for both formal and informal negative commands.
</TipBox>
...
<!-- prettier-ignore -->
<TipBox>
When using softening strategies, consider the context and relationship with the person you are addressing to ensure appropriateness.
</TipBox>
