...
const FullAudioPlayer: React.FC<FullAudioPlayerProps> = ({ isPlaying, currentTime, duration, playbackRate, setPlaybackRate, isRepeating, handlePlayPause, handleRepeat, handleAudioPlayerProgressBarClick }) => (
	<div className="bg-primary-200 rounded-lg p-4 flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4 shadow-lg hover:shadow-xl">
		<AudioPlayerControls isPlaying={isPlaying} handlePlayPause={handlePlayPause} handleRepeat={handleRepeat} isRepeating={isRepeating} />
