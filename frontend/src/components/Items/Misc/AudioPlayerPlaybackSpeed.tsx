...
const AudioPlayerPlaybackSpeed: React.FC<AudioPlayerPlaybackSpeedProps> = ({ playbackRate, setPlaybackRate }) => (
	<div className="inline-block relative w-24">
		<select
			...
			className="block appearance-none w-full bg-backgroundalt border border-gray-200 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline dark:bg-indigo-600"
		>
